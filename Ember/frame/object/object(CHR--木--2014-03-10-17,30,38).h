...
#define createCbAda(proc) _sys_createEventAdaptor(&proc)
		inline typename CallBackAdaptor::Handle _sys_createEventAdaptor(CallBackAdaptor<T>::StaticProc f)
		{

		}
		inline typename CallBackAdaptor::Handle _sys_createEventAdaptor(CallBackAdaptor<T>::ObjectProc  f)
		{
